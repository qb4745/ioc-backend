...
**Período:** 6 de Octubre - 24 de Octubre, 2025  
...
**Capacidad Teórica del Sprint:** 30 SP (10 SP/semana × 3 semanas)
**Capacidad Comprometida:** 21 SP (70% de capacidad - incluye buffer 30%)
**Buffer para Impedimentos:** 9 SP (~30% reservado para spikes técnicos, riesgos e imprevistos)

**Justificación del Buffer Amplio:**
- Riesgo alto: Generación de PDFs complejos (35% probabilidad)
...
**"Transformar el dashboard estático en una herramienta de análisis interactiva donde el usuario final pueda filtrar datos por línea, período y maquína, además de comparar desempeño entre turnos y líneas para investigar patrones de rendimiento y exportar resultados."**
...
**⚠️ ACTUALIZACIÓN 14 DE OCTUBRE, 2025 (Día 6 de 15):**
...
- Completados: 0 SP
- Restantes: 21 SP
- **🔴 Alerta:** Estamos en el día 6 de 15 (~40% del tiempo). Esperado: ~8 SP completados
- **Acción Requerida:** Daily Standup urgente para evaluar si se mantiene el alcance o se activa Plan B
...
- **Total: 22 tareas**
- **⚠️ Nota:** Boris también actúa como Product Owner (~20% de tiempo en validaciones, refinamiento Sprint 3)
- **Capacidad Efectiva:** ~80% = 17.6 tareas equivalentes
- **Sobrecarga:** +4.4 tareas (~25% sobre capacidad)

**🔴 Carga Desbalanceada:** Boris tiene 22 tareas vs Jaime 16 tareas, pero Boris además es PO.

**Recomendación de Rebalanceo:**
- Mover **TEST-TASK-06** (tests de ReportExportService) → Jaime (tiene más experiencia en testing)
- Mover **DOC-TASK-02** (guía de usuario) → Jaime (puede paralelizar con IOC-012)
- Considerar **pair programming** en BE-TASK-35 (ReportExportService) entre ambos

**Nueva distribución propuesta:**
- Boris: 19 tareas (sobrecarga reducida a ~8% considerando rol PO)
- Jaime: 19 tareas (incremento manejable de ~19%)
- Balance mejorado: ambos con carga similar
...
**Activación:** Día 2 del sprint, después del spike técnico, si se confirma que Metabase no soporta filtros dinámicos.
...
- Code reviews tempranas detectaron problemas antes de QA
