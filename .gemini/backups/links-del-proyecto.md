# Enlaces Importantes del Proyecto IOC
...
- **URL Segura (HTTPS vía Cloudflare Tunnel):**
  - `https://treated-paste-eos-memo.trycloudflare.com/`
  - *Este es el enlace que se debe usar en la configuración del backend para el embedding.*
...
- **Health Check Específico del ETL:**
